...
* Timestamps are handled in UTC. If no end date is set, the current time is used as end of the download window. The time-range check compares the dates selected by the user with the first/last deployed location of the whole study, not of the selected animals.
